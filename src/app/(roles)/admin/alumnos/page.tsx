...
const STATUS_MAP: Record<string, { tone: "success" | "error"; text: string }> = {
  ...
  alumnos_bulk_deleted: { tone: "success", text: "Baja masiva aplicada a los alumnos visibles." },
  alumnos_bulk_partial: { tone: "success", text: "Baja masiva aplicada parcialmente. Se omitieron alumnos con matriculas activas o ya dados de baja." },

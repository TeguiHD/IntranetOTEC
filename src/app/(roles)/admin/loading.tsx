  ...
  return (
    <section className="space-y-5">
      ...
      <div className="animate-pulse rounded-2xl bg-gradient-to-r from-primary/40 to-primary-dark/40 p-5 sm:p-6">
        ...
        <div className="mt-2 h-4 w-72 rounded-lg bg-white/15" />
      </div>

      {/* Metrics row skeleton */}
      <div className="grid animate-pulse grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-7">
        {Array.from({ length: 7 }).map((_, i) => (
          <div
            key={i}
            className="rounded-xl border border-gray-100 bg-white p-3 text-center dark:border-gray-800 dark:bg-gray-900"
          >
            <div className="mx-auto h-8 w-10 rounded-md bg-gray-200 dark:bg-gray-700" />
            <div className="mx-auto mt-1.5 h-3 w-14 rounded-md bg-gray-100 dark:bg-gray-800" />
          </div>
        ))}
      </div>
        ...
        {Array.from({ length: 6 }).map((_, i) => (
          ...
          >
            ...
            <div className="w-full space-y-2 text-center">
              <div className="mx-auto h-4 w-20 rounded-md bg-gray-200 dark:bg-gray-700" />
              <div className="mx-auto hidden h-3 w-32 rounded-md bg-gray-100 dark:bg-gray-800 sm:block" />
            </div>
          </div>
        ))}
      </div>
      ...
      <article className="animate-pulse rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900 sm:p-6">
        <div className="h-5 w-48 rounded-lg bg-gray-200 dark:bg-gray-700" />
        <div className="mt-2 h-4 w-80 rounded-lg bg-gray-100 dark:bg-gray-800" />
        <div className="mt-5 space-y-3">
          {Array.from({ length: 4 }).map((_, i) => (
            ...
            >
              ...
              <div className="h-6 w-12 rounded-md bg-gray-200 dark:bg-gray-700" />
            </div>
          ))}
        </div>
      </article>

                ...
                <div className="mt-4 grid grid-cols-4 gap-2">
                  {Array.from({ length: 8 }).map((_, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        title={sesion ? `${normalizarTextoVisible(sesion.titulo)} - ${ESTADO_LABELS[sesion.estado ?? ""] ?? "Pendiente"}` : "Sin clase programada"}
              ...
              <div className="flex items-center justify-between">
                <div>
                  <h2 className="text-base font-semibold text-text-primary dark:text-white sm:text-lg">
                    {normalizarTextoVisible(group.nombre)}
                  </h2>
                  ...
                  >
                    <div className="min-w-0 flex-1">
                      <p className="truncate font-medium text-text-primary dark:text-white">
                        {normalizarTextoVisible(row.claseTitulo)}
                      </p>

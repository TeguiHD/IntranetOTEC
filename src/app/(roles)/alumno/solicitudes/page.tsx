...
const ESTADO_STYLES: Record<string, string> = {
  pendiente: "bg-warning/15 text-amber-700 dark:bg-amber-950 dark:text-amber-300",
  aprobada: "bg-success/15 text-green-700 dark:bg-green-950 dark:text-green-300",
  rechazada: "bg-danger/15 text-red-700 dark:bg-red-950 dark:text-red-300",
};

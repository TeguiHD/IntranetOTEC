  ...
  return (
    <section className="space-y-5">
      ...
      <div className="animate-pulse rounded-2xl bg-gradient-to-r from-primary/40 to-primary-dark/40 p-5 sm:p-6">
        ...
        <div className="mt-2 h-4 w-64 rounded-lg bg-white/15" />
      </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-1.5">
                <div className="h-7 w-8 rounded-md bg-gray-200 dark:bg-gray-700" />
                <div className="h-3 w-20 rounded-md bg-gray-100 dark:bg-gray-800" />
              </div>
            </div>
          </div>
        ))}
      ...
      {/* Active courses card skeleton */}
      <div className="animate-pulse rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
        ...
        <div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {Array.from({ length: 3 }).map((_, i) => (
            ...
            >
              ...
              <div className="mt-1.5 h-3 w-20 rounded-md bg-gray-100 dark:bg-gray-800" />
            </div>
          ))}
        </div>
      </div>
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          ...
          >
            ...
            <div className="w-full space-y-2 text-center">
              <div className="mx-auto h-4 w-28 rounded-md bg-gray-200 dark:bg-gray-700" />
              <div className="mx-auto hidden h-3 w-36 rounded-md bg-gray-100 dark:bg-gray-800 sm:block" />
            </div>
          </div>
        ))}
      </div>

            ...
            <article className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
              <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-xs text-text-secondary dark:text-gray-400">
                    {materialesSeleccionados.length} archivo{materialesSeleccionados.length === 1 ? "" : "s"}
                  </p>
                </div>
                <Link
                    ...
                    >
                      <div className="min-w-0">
                        <a
                          ...
                          className="truncate text-sm font-semibold text-primary underline hover:opacity-80 dark:text-primary-light"
                        >

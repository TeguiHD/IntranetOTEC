...
const ADMIN_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { href: "/admin/academico", label: "Vista académica", Icon: LayoutGrid, gradient: "grad-purple", capability: "cursos.admin" },
      { href: "/admin/asignaturas", label: "Secciones", Icon: Layers, gradient: "grad-blue", capability: "asignaturas.admin" },
      { href: "/admin/cursos", label: "Cursos", Icon: BookOpen, gradient: "grad-indigo", capability: "cursos.admin" },
      { href: "/admin/periodos", label: "Periodos", Icon: CalendarRange, gradient: "grad-violet", capability: "cursos.admin" },
      { href: "/admin/horarios", label: "Horarios", Icon: CalendarRange, gradient: "grad-teal", capability: "horarios.admin" },
      { href: "/admin/clases", label: "Clases", Icon: PlaySquare, gradient: "grad-cyan", capability: "clases.admin" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/notas", label: "Notas", Icon: PencilLine, gradient: "grad-gold", capability: "notas.admin" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/admin/historial", label: "Historial", Icon: History, gradient: "grad-slate", capability: "historial.admin" },
      { href: "/admin/finanzas", label: "Finanzas", Icon: TrendingUp, gradient: "grad-emerald", capability: "finanzas.admin" },
      { href: "/admin/auditoria", label: "Auditoria", Icon: ShieldCheck, gradient: "grad-slate", capability: "auditoria.admin" },
    ],
  },
  {
    title: "Sistema",
